...
<section class="product_view_bg d-flex flex-column justify-content-between align-items-center">
    ...
    <div class="social_media_mobile mt-4 d-flex justify-content-between">
        <a target="_blank" href="https://vk.com/killmeobladaet" class="mx-4">
            <img src="img/icon_vk.png" alt="vk">
        </a>
        <a target="_blank" href="https://www.instagram.com/obladaet/?hl=ru" class="mx-4">
            <img src="img/icon_instagram.png" alt="instagram">
        </a>
        <a target="_blank" href="https://www.youtube.com/user/obladaetgrime" class="mx-4">
            <img src="img/icon_youtube.png" alt="youtube">
        </a>
    </div>
